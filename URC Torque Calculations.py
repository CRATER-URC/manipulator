...
torque4 = 2*(massbox + masslink5) * gravity * L_m/2

torque3 = 2*((massbox+masslink5) * (Dtheta3theta4 + L_m/2) * gravity) + (masstheta4 * gravity * Dtheta3theta4) + (masslinktheta3theta4 * gravity * (Dtheta3theta4/2)) 

torque2 = 2*((massbox + masslink5) * (Dtheta2theta3 + Dtheta3theta4 + L_m/2) * gravity) + (masstheta3 * Dtheta2theta3 * gravity) + (masslinktheta2theta3 * gravity * Dtheta2theta3/2) + (masstheta4 * gravity * (Dtheta2theta3 + Dtheta3theta4)) + (masslinktheta3theta4 * gravity * (Dtheta2theta3 + Dtheta3theta4/2))

torque1 = 2*((massbox + masslink5) * (Dtheta1theta2 + Dtheta2theta3 + Dtheta3theta4 +L_m/2) * gravity) + (masstheta4 * gravity * (Dtheta1theta2 + Dtheta2theta3 + Dtheta3theta4)) +(masslinktheta3theta4  * gravity *(Dtheta1theta2 + Dtheta2theta3 + Dtheta3theta4/2))+(masstheta3 * gravity * (Dtheta1theta2 + Dtheta2theta3))+(masslinktheta2theta3 * gravity * (Dtheta1theta2 + Dtheta2theta3/2))+(masstheta2 * gravity * Dtheta1theta2)+(masslinktheta1theta2 * gravity * Dtheta1theta2/2)
