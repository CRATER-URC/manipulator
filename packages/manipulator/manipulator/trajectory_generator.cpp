    ...
    public:
        TrajectoryGenerator() : Node("send_trajectory")
        {
            ...
            timer_ = this->create_wall_timer(
                500ms, std::bind(&TrajectoryGenerator::timer_callback, this));
            subscriber_ = this->create_subscription<geometry_msgs::msg::Twist>(
                "/r6bot_controller/command", 10, std::bind(&TrajectoryGenerator::cmd_callback, this, std::placeholders::_1));
        }
    private:
        void timer_callback()
        {
        ...
        rclpp::Publisher<trajectory_msgs::msg::JointTrajectory>::SharedPtr publisher_;
        rclpp::TimerBase::SharedPtr timer_;
        rclpp::Subscription<geometry_msgs::msg::Twist>::SharedPtr subscriber_;
...
//     return 0;
  ...
  while (rclcpp::ok())
  {
    // If get command and command hasn't already been sent?
    //      generate trajectory
    //      send trajectory msg
  }
